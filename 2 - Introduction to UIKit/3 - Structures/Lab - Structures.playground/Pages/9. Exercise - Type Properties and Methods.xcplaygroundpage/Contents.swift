...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Ashu", email: "ashu@gmail.com", age: 18)
 ...
 */
var someotherUser = User(userName: "harsh", email: "harsh@gmail.com", age: 19)

User.logIn(user: someotherUser)
